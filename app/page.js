  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 32, fontFamily: 'sans-serif' }}>
      ...
      <p style={{ color: '#666', marginBottom: 24 }}>
        Add businesses to your video queue
      </p>
      ...
      {businesses.map((biz, i) => (
        <div key={i} style={{ border: '1px solid #ddd', borderRadius: 8,
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            {businesses.length > 1 && (
              <button onClick={() => removeBusiness(i)}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 12 }}>
            <div>
              ...
              <input value={biz.business_name}
                onChange={e => updateBusiness(i, 'business_name', e.target.value)}
            ...
            <div>
              ...
              <input value={biz.offer}
                onChange={e => updateBusiness(i, 'offer', e.target.value)}
            ...
            <div>
              ...
              <input value={biz.website_url}
                onChange={e => updateBusiness(i, 'website_url', e.target.value)}
            ...
            <div>
              ...
              <select value={biz.template_name}
                onChange={e => updateBusiness(i, 'template_name', e.target.value)}
                style={{ width: '100%', padding: 8, border: '1px solid #ddd',
                  borderRadius: 4, marginTop: 4, boxSizing: 'border-box' }}>
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              ...
              <input type="file" accept="image/*"
                onChange={e => updateBusiness(i, 'logo', e.target.files[0])}
      ...
      <button onClick={addBusiness}
        style={{ width: '100%', padding: 12, border: '2px dashed #aaa',
          borderRadius: 8, background: 'none', cursor: 'pointer',
          marginBottom: 16, fontSize: 15 }}>
        + Add Another Business
      </button>

      {error && <div style={{ background: '#fee', padding: 12,
        borderRadius: 6, color: 'red', marginBottom: 12 }}>{error}</div>}
      {success && <div style={{ background: '#efe', padding: 12,
        borderRadius: 6, color: 'green', marginBottom: 12 }}>{success}</div>}

      <button onClick={handleSubmit} disabled={uploading}
        style={{ width: '100%', padding: 14, background: '#000',
